...
window.addEventListener('load', function(){
	...
	msgInputLine = document.querySelector('.msginput input');
  	...
  	addString('<span style="color:#000;font-weight:bold">Benutze T, um den Chat zu öffnen.</span>');
  	addString('<span style="color:#000;font-weight:bold">Benutze /h für Tastenbelegung.</span>');
	alt.emit('chatloaded');
});
